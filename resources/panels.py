...
class PointMapPanel(Panel):
    ...
    def get_form_options(self):
        ...
        if self.widget:
            opts["widgets"] = {self.relation_name: self.widget}

        if self.permission:
            opts["field_permissions"] = {self.relation_name: self.permission}
    ...
    def db_field(self):
        ...
        return model._meta.get_field(self.relation_name)
